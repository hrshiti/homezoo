...
const RazorpayButton = ({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-2 bg-amber-700 text-white font-bold py-3 px-6 rounded-xl shadow-md hover:bg-amber-800 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
    >
      {loading ? (
        <>
