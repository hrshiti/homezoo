                ...
                {showAddMoneySheet && (
                    <>
                        ...
                        >
                            ...
                            <div className="bg-gray-50 rounded-2xl p-4 mb-2 flex items-center gap-3 border border-gray-200 focus-within:border-amber-600 focus-within:ring-1 ring-amber-600 transition-all">
                            ...
                            <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
                                {quickAmounts.map(amt => (
                                    <button
                                        ...
                                        className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-bold text-gray-600 hover:bg-amber-600 hover:text-white hover:border-amber-600 transition-all whitespace-nowrap"
                                    >
                                        +₹{amt}
                                    </button>
                                ))}
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center mb-6">
                                ...
                                <h3 className="text-xl font-black text-amber-900 text-center leading-tight mb-1">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-3 space-y-3">
                                ...
                                {selectedTransaction.bookingId && (
                                    <div className="flex justify-between items-center bg-white/50 p-2 rounded-lg border border-gray-100">
                                        ...
                                        <span className="text-[10px] font-bold text-amber-700 bg-amber-700/5 px-2 py-0.5 rounded">
                                            #{selectedTransaction.bookingId}
                                        </span>
                                    </div>
                                )}
