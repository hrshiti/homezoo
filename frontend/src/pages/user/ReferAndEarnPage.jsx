...
const ReferAndEarnPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-surface via-surface to-amber-900">
                ...
                <div className="px-5 pb-32">
                    <AnimatePresence mode="wait">
                        ...
                        {activeTab === 'earnings' && (
                            ...
                            >
                                {/* Total Earnings Card */}
                                <div className="bg-gradient-to-br from-surface to-amber-900 rounded-2xl p-6 shadow-xl relative overflow-hidden">
